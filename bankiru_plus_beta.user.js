...
var functionsSequence = [
       ...
       { address: 'banki\\.ru\\/services\\/responses\\/bank\\/.*?', functions: 'deleteHRRigthBlock, addRSSToResponces, recollapseResponses, listOfResponses, addAdditionalSearchToResponces', isLast: true },
...
bankiruPage.addUserScriptMenu = function() {
    if (!page.oldDisign) {
        ...
        .end().find("li.spoiler__item").remove() //удаляем ссылки
