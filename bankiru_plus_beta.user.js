    ...
    var observer = new MutationObserver(function(mutations) {
        ...
        $(ARTICLE_COMMENT_FILTER).each(function() {
            ...
            $(article).find(DIV_COMMENT_LINKS_FILTER)
                ...
                .append('<span class="pseudo-link" type="name_quote" name="'+nick+'" alt="Цитировать" id="'+prefix+'quote"+>Цитировать</a>&nbsp;&nbsp;<span class="pseudo-link" title="Вставить в ответ имя" type="name" name="'+nick+'">Имя</a>')    
