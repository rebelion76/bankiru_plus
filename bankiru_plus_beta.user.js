...
// Подключим jQuery StyleSheet http://plugins.jquery.com/stylesheet/
(function($){function f(n,styleSheet){try{if(styleSheet[t]){n=n||"";var i=$(styleSheet.ownerNode||styleSheet.owningElement);return n===""||n==="*"||"#"+(i.prop("id")||"")==n||(i.prop("href")||"")==r.prop("href",n).prop("href")}return!1}catch(u){return!1}}function e(n){var styleSheet=(/.*?{/.exec(n)||["{"])[0],t=/{.*}/g.exec(n),i;return t===null?(i=n.split("{"),t="{"+i[i.length==1?0:1].split("}")[0]+"}"):t=t[0],{styleSheet:$.trim(styleSheet.substr(0,styleSheet.length-1)),selectorText:c(t.substr(1,t.length-2))}}function c(i){var u=[],f,e,r;for(f=n[t].length,s.call(n,i,";"),e=n[t].length,r=e-1;r>=f;r--)u.push(n[t][r].selectorText),h.call(n,r);return u.reverse().join(", ")}function l(n,t,i){return $.type(n.selectorText)!=="string"?!1:n.selectorText===t?!0:i===!0?$($.map(n.selectorText.split(","),$.trim)).filter(function(){return this.toString()===t}).length>0:!1}function a(n){for(var f=n[0].toUpperCase()+n.slice(1),t,r=u.length;--r;)if(t=u[r]+f,t in i)return t;return n}function o(n,styleSheet){return n.ownerDocument=n.ownerDocument||document,n.nodeType=n.nodeType||1,n.nodeName=n.nodeName||"DIV",n.parentNode=n.parentNode||styleSheet.ownerNode||styleSheet.owningElement,n.parentStyleSheet=n.parentStyleSheet||styleSheet,n}function s(n,i,r){if(!n||!i)return-1;var u=this,f=u.insertRule?function(n,t,i){this.insertRule(n+"{"+t+"}",i)}:u.addRule;r=r||this[t].length;try{return f.call(u,n,i,r)}catch(e){return $.each(n.split(","),function(n,t){f.call(u,$.trim(t),i)}),-1}}function h(n){if(n=n&&n.rule?n.rule:n,n){var i=this,r=i.deleteRule||i.removeRule;r||$(document.styleSheets).each(function(u,styleSheet){if($(styleSheet[t]).filter(function(){return this===n}).length==1)return i=styleSheet,r=i.deleteRule||i.removeRule,!1});$.type(n)=="number"?r.call(i,n):$.each(i[t],function(t,u){if(n===u)return r.call(i,t),!1})}}var r=$(document.createElement("a")),i=r.prop("style"),n=function(n){return n.sheet||n.styleSheet}($('<style type="text/css">*{}<\/style>').appendTo("head")[0]),t="cssRules"in n?"cssRules":"rules",u=["Webkit","O","Moz","ms"];try{o(n[t][0],n);$.support.nativeCSSStyleRule=!0}catch(v){$.support.nativeCSSStyleRule=!1;CSSStyleRule=function(n){$.extend(this,n);this.rule=n;this.currentStyle=n.style}}$.stylesheet=function(n,t,i){return(this instanceof $.stylesheet)?(this.init(n),this.css(t,i)):new $.stylesheet(n,t,i)};$.extend($.stylesheet,{cssRules:function(n){var r=[],i=e(n);return $(document.styleSheets).each(function(n,styleSheet){f(i.styleSheet,styleSheet)&&$.merge(r,$(styleSheet[t]).filter(function(){return l(this,i.selectorText,i.styleSheet==="*")}).map(function(){return o($.support.nativeCSSStyleRule?this:new CSSStyleRule(this),styleSheet)}))}),r.reverse()},camelCase:$.camelCase||function(n){return n.replace(/-([\da-z])/g,function(n){return n.toUpperCase().replace("-","")})},cssProps:$.cssProps||{},cssStyleName:function(n){if(n){var t=$.camelCase(n);if(t in i)return t;if(($.cssProps[n]||($.cssProps[n]=a(t)))in i)return $.cssProps[n]}}});$.stylesheet.fn=$.stylesheet.prototype={init:function(t){var i=[];switch($.type(t)){case"string":i=$.stylesheet.cssRules(t);break;case"array":$.each(t,function(n,t){$.type(t)==="string"?$.merge(i,$.stylesheet.cssRules(t)):t instanceof CSSStyleRule&&i.push(t)});break;case"object":t instanceof CSSStyleRule&&i.push(val)}$.extend(this,{rules:function(){return i.slice()},css:function(r,u){var o=this,c=undefined,l,v,a;switch($.type(r)){case"null":return $.each(i,function(n,t){h.call(t.parentStyleSheet,t)}),i=$.stylesheet.cssRules(t),o;case"string":l=$.stylesheet.cssStyleName(r);l&&(i.length===0&&u!==undefined?(v=e(t),a=$(document.styleSheets).filter(function(){return f(v.styleSheet,this)}),a=a&&a.length==1?a[0]:n,s.call(a,v.selectorText,r+":"+u+";"),i=$.stylesheet.cssRules(t),c=o):($.each(i,function(n,t){if(t.style[l]!=="")return u!==undefined?(t.style[l]=u,c=o):c=t.style[l],!1}),c===undefined&&u!==undefined&&(i[0].style[l]=u,c=o)));break;case"array":c={};$.each(r,function(n,t){c[t]=o.css(t,u)});u!==undefined&&(c=o);break;case"object":return $.each(r,function(n,t){o.css(n,t)}),o;default:return o}return c}})}}})(jQuery)
...
(function ()
{
    ...
    { 
        if (page.oldDisign) { deleteHRRigthBlock(); }  
    ...
    /* профиль */
        ...
        addHrefsToProfile(windowLocation); 
        change10ThanksToAll(); 
        if (/banki\.ru\/profile\/\?UID=\d+#\d/.test(windowLocation)) { 
    ...
    { 
       ...
       if (/banki\.ru\/forum\/.*?PAGE_NAME=read&FID=10&TID=100712&banki_ru_plus_hidden_rid=.*/.test(windowLocation)) { addUrlToRecovery(windowLocation); }
       if (/banki\.ru\/(.*)FID=72/.test(windowLocation)) { addCommentFormToForum(); }
       addLinksToHiddenUserInfo(); 
       addHotKeysTo('forum', windowLocation); 
       addGotoPage(); 
       addSpacesToSmallThank(); 
    ...
    /* друзья */  // TODO НАДО РАЗОБРАТЬСЯ
    else if (/banki\.ru\/friends\/group\/.*?\/forum\/.*/.test(windowLocation)) { 
        reloadFriendsToForum(windowLocation); 
    }
