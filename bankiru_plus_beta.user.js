...
bankiruPage.hiddenResponse = function() {
...
bankiruPage.addRSSToLenta.nameForUser = "RSS на разделы новостей в 'хлебных крошках'";

bankiruPage.addRSSToBankNews = function() {
    addRSS('banknews');
}
bankiruPage.addRSSToBankNews.nameForUser = "RSS новостей банка в 'хлебных крошках'";
...
bankiruPage.addRSSToResponces.nameForUser = "RSS на отзывы и ответы ПБ в 'хлебных крошках' НР";
...
bankiruPage.addRSSToListOfBanks.nameForUser = 'RSS на отзывы и ответы ПБ в списке банков НР';
